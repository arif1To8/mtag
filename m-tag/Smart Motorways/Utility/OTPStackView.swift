...
//    let numberOfFields = 4
    ...
    //Colors
    let inactiveFieldBorderColor = ColorConstants.silver
    let textBackgroundColor = ColorConstants.white
...
//        textField.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -8).isActive = true
        ...
        textField.font = FontConstants.regular?.withSize(20)
        textField.textColor = ColorConstants.textGray
